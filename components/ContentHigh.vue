...
const slideWidth = ref(470) // 초기값 설정

// 슬라이드 넓이를 계산하는 함수 추가
const calculateSlideWidth = () => {
    if (window.innerWidth < 480) {
        slideWidth.value = 290 // 240px + 50px margin
    } else if (window.innerWidth < 980) {
        slideWidth.value = 290 // 240px + 50px margin
    } else {
        slideWidth.value = 470 // 420px + 50px margin
    }
}
...
<style lang="scss" scoped src="~/assets/scss/content_high.scss"></style>